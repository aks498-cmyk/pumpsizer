...
def annual_energy_kwh(input_electrical_kw: float, hours_per_day: float,
...
def annual_energy_cost(energy_kwh: float, tariff_per_kwh: float,
                       demand_charge_per_kw_month: float = 0.0,
                       rated_kw: float = 0.0) -> float:
...
def life_cycle_cost(capital_cost: float, annual_energy_cost_value: float,
                    annual_maintenance_cost: float = 0.0, *,
                    years: int = 20, discount_rate: float = 0.08) -> dict:
