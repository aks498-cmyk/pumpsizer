...
def test_npsh_flooded_positive_and_check():
    r = npsh_available(
        atmospheric_head_m=10.33,
        static_suction_head_m=0.0,
        suction_friction_loss_m=0.05,
        suction_minor_loss_m=0.15,
        suction_velocity_head_m=0.03,
        vapour_pressure_head_m=0.43,
        safety_margin_m=0.5,
        npsh_required_m=3.5,
    )
...
def test_npsh_lift_can_fail():
    r = npsh_available(
        atmospheric_head_m=10.33,
        static_suction_head_m=-7.0,
        suction_friction_loss_m=1.0,
        suction_minor_loss_m=0.5,
        suction_velocity_head_m=0.1,
        vapour_pressure_head_m=0.43,
        npsh_required_m=3.5,
    )
